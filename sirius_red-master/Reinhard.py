...
Code adapted from https://staintools.readthedocs.io/en/latest/_modules/staintools/normalization/reinhard.html
...
class Normalizer(object):
    ...
    def __init__(self, source_path=None):
        ...
        source_image = read_image(os.path.abspath(self.source_path))

        self.fit(source_image)
    ...
    def transform(self, I):
        ...
        return torch.Tensor(merge_back(norm1, norm2, norm3).transpose((2, 0, 1)))/255 # Put channels first again
